...
async function probarAPI() {
  try {
    ...
    console.log(
      `   ✅ ${productosResponse.data.productos.length} productos encontrados`
    );
    ...
    console.log(
      "   ✅ Usuario actualizado:",
      updateResponse.data.usuario.nombre
    );
    ...
    console.log(
      `   ✅ ${usuariosResponse.data.usuarios.length} usuarios encontrados`
    );
    ...
    console.log(
      "   ✅ Producto creado:",
      createProductResponse.data.producto.nombre
    );
